...
import { 
  ...
  FaCog, FaBell, FaFileAlt, FaChartLine, FaFlag, FaEnvelope,
  FaStar, FaComments, FaCalendarAlt, FaWallet, FaQuestionCircle
} from 'react-icons/fa';
...
const DashboardLayout = ({ children, title }) => {
  ...
  const getMenuItems = () => {
    const commonItems = [
      ...
      { path: '/dashboard/profile', icon: FaUserCircle, label: 'My Profile', roles: ['worker', 'employer', 'recruiter', 'admin', 'embassy'] },
        ...
        <div className="dashboard-header d-flex justify-content-between align-items-center">
          ...
          <div className="header-actions d-flex gap-3">
            <Button variant="light" size="sm">
              <FaBell /> {!sidebarCollapsed && ' Notifications'}
            </Button>
            <Button variant="light" size="sm">
